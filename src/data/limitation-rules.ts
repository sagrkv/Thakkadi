...
export const LIMITATION_RULES: LimitationRule[] = [
  ...
  // ============================================
  {
    ...
    limitationDays: 30,
    copyExclusionAllowed: true,
    lawReference: "Section 415, BNSS 2023 (formerly Section 374, CrPC); Article 115(c), Limitation Act",
  ...
  },
  {
    ...
    limitationDays: 90,
    copyExclusionAllowed: true,
    lawReference: "Sections 438 & 442, BNSS 2023 (formerly Sections 397 & 401, CrPC)",
  ...
  // ============================================
  {
    ...
    limitationDays: 60,
    copyExclusionAllowed: true,
    lawReference: "Section 415, BNSS 2023 (formerly Section 374, CrPC); Article 115(b), Limitation Act",
  ...
  // ============================================
  {
    ...
    limitationDays: 60,
    copyExclusionAllowed: true,
    lawReference: "Article 134, Constitution; Section 420, BNSS 2023 (formerly Section 379, CrPC)",
