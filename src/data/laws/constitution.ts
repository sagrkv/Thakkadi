...
const ACT_ID = 'constitution';

export const CONSTITUTION_SECTIONS: readonly LegalSection[] = [
  {
    id: `${ACT_ID}/article-132`,
    actId: ACT_ID,
    sectionType: 'article',
    number: '132',
  ...
  },
  {
    ...
    summary:
      'Confers discretionary power on the Supreme Court to grant special leave to appeal (SLP) from any court or tribunal in India, except military tribunals.',
    externalUrl: 'https://indiankanoon.org/doc/427855/',
  },
  {
    id: `${ACT_ID}/article-226`,
    actId: ACT_ID,
    sectionType: 'article',
    number: '226',
    ...
    summary:
      'Empowers High Courts to issue writs (habeas corpus, mandamus, prohibition, quo warranto, certiorari) for enforcement of fundamental rights and for any other purpose.',
    externalUrl: 'https://indiankanoon.org/doc/1712542/',
  },
  {
    id: `${ACT_ID}/article-227`,
    actId: ACT_ID,
    sectionType: 'article',
    number: '227',
